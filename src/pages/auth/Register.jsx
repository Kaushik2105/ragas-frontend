    ...
    <main className="auth-screen">
      <section className="auth-card wide">
        ...
        <div style={{ marginTop: '14px', paddingTop: '18px', borderTop: '1px solid var(--border)', textAlign: 'center' }}>
          ...
          <a href="https://github.com/Kaushik2105/Ragas-Mobile/releases/download/v1.0.6/ragas-v1.0.6.apk" target="_blank" rel="noopener noreferrer" className="ghost-button" style={{ width: '100%', textDecoration: 'none' }}>
